    ...
    <div id="about" className="about text-white min-h-screen flex flex-col items-center">
      ...
      <div className="container pt-8 mt-6 min-h-full w-full flex flex-col justify-center items-center gap-4 lg:gap-0 lg:flex-row">
        <div className="w-full h-[15rem] flex flex-col items-center justify-center md:h-[20rem] lg:w-[34%] lg:h-full xl:w-[30%] 2xl:w-[25%]">
          <div data-aos="fade-in" data-aos-duration="1000"  className="w-[15rem] h-[15rem] flex items-center justify-center backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-full md:w-[20rem] md:h-[20rem] overflow-hidden">
            <img src={photo} className="w-[90%] mt-8" alt="" />
          </div>
        ...
        <div className="w-full h-auto flex flex-col items-center gap-4 lg:h-[90%] lg:w-[65%] 2xl:w-[55rem]">
          <div className="w-[90%] h-auto flex flex-col gap-4 lg:h-[70%] lg:w-full lg:flex-row">
            <div data-aos="fade-up" data-aos-duration="2000" ref={aboutRef}  className="w-[100%] h-[20rem] backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-2xl lg:h-full lg:w-[67%] flex flex-col p-6 pt-8">
              <span className="text-2xl font-semibold mb-6">Vilas Balu Rabad</span>
              <span className="text-justify overflow-y-scroll lg:overflow-hidden px-2">Currently pursuing a Bachelor of Technology in Information Technology at Vishwakarma Institute of Information Technology (VIIT), Pune. My focus lies in web development, where I leverage ReactJS and diverse technologies to build user-centric, interactive experiences. I possess a strong foundation in problem-solving and a passion for crafting elegant solutions. Explore my portfolio to discover my capabilities and potential as a developer.</span>
            </div>
            <div className="w-[100%] h-[10rem] flex gap-2 lg:flex-col lg:h-full lg:w-[31%]">
              <div data-aos="fade-down" className="w-1/2 h-full backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-2xl lg:h-[45%] lg:w-full p-4 text-lg font-semibold z-[5]">
              ...
              <div data-aos="fade-down" className="w-1/2 h-full backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-2xl lg:h-[55%] lg:w-full p-4 text-lg z-[4]">
          ...
          <div data-aos="fade-up" data-aos-duration="2000" className="w-[90%] h-[7rem] overflow-x-scroll lg:overflow-hidden flex items-center backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-2xl lg:w-full">
