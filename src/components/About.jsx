        ...
        <div className="w-full h-auto flex flex-col items-center gap-4 lg:h-[90%] lg:w-[65%] 2xl:w-[55rem]">
          <div className="w-[90%] h-auto flex flex-col gap-4 lg:h-[70%] lg:w-full lg:flex-row">
            ...
            <div className="w-[100%] h-[10rem] flex gap-2 lg:flex-col lg:h-full lg:w-[31%]">
              <div data-aos="fade-down" className="w-1/2 h-full backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-3xl lg:h-[45%] lg:w-full p-4 text-lg font-semibold z-[5]">
              ...
              <div data-aos="fade-down" className="w-1/2 h-full backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-3xl lg:h-[55%] lg:w-full p-4 text-lg z-[4]">
          ...
          <div data-aos="fade-up" data-aos-duration="2000" className="w-[90%] h-[7rem] overflow-x-scroll lg:overflow-hidden flex items-center backdrop-blur-sm bg-gradient-to-b from-higherCardColor to-lowerCardColor rounded-3xl lg:w-full">
