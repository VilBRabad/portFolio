...
function ErrorPage() {
  return (
    <div className="h-screen w-screen dark:text-white relative flex flex-col items-center justify-center z-10 overflow-hidden">
      ...
      <Link to="/portFolio/" className="absolute top-[55%] z-10"><button className="text-lg h-10 w-20 rounded-md transition bg-purple-800 hover:bg-purple-700 border-md">Home</button></Link>
