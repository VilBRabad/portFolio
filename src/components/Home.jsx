...
function Home({setVisible, homeRef}) {
  ...
  return (
    <div  id="home" className="h-[91vh] w-screen relative z-2 flex items-center justify-center text-black dark:text-white overflow-hidden z-10">
      <div ref={homeRef} className="relative -mt-16 container h-full w-full justify-center items-center flex flex-col z-10">
        ...
        <Link to="https://github.com/VilBRabad/portFolio" target="_blank"><img src={github} alt="" className="absolute h-12 dark:invert -bottom-0 right-4 lg:-bottom-4"/></Link>
      </div>
