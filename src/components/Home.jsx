...
function Home({setVisible, homeRef}) {
  ...
  return (
    <div  id="home" className="h-[91vh] w-screen relative z-2 flex items-center justify-center overflow-hidden">
      <div ref={homeRef} className="relative container h-full w-full justify-center items-center flex text-white flex-col z-8">
        ...
        <a href="https://github.com/VilBRabad/portFolio" target="_blank"><FaGithub className="absolute text-white text-3xl bottom-4 right-4"/></a>
      </div>
