  ...
  return (
    ...
    <div  id="home" className="h-[91vh] w-screen relative flex items-center justify-center text-black dark:text-white overflow-x-hidden">
      <div ref={homeRef} className="relative -mt-16 container h-full w-full justify-center items-center flex flex-col z-10">
        ...
        <span data-aos="fade-up" data-aos-duration="1000"  className="w-[85%] text-[1.4rem] min-[376px]:text-[1.6rem] font-bold z-3 text-center lg:text-[2rem] text-white/50">Welcome to my portfolio! <p className="text-white flex items-center justify-center flex-wrap text-[2.4rem] min-[376px]:text-[2.6rem] lg:text-[4rem] gap-0 min-[350px]:gap-4">I'm <span className="text-purple-500">Vilas Rabad</span></p></span>
