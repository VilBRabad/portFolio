  ...
  return (
    <div  id="home" className="h-[91vh] w-screen relative z-2 flex items-center justify-center overflow-hidden">
      <div ref={homeRef} className="relative -mt-16 container h-full w-full justify-center items-center flex text-white flex-col z-8">
        ...
        <span data-aos="fade-up" data-aos-duration="1000"  className="w-[85%] text-[3rem] font-bold z-3 text-center lg:text-[4rem]">Hello, I'm <span className="text-[#9D84FF]">Vilas Rabad</span></span>
        <span data-aos="fade-up" data-aos-duration="1500"  ref={myRef} className="text-[1.6rem] text-[#C5DFF8] mb-6 z-3">Web Developer (React)</span>
        <span data-aos="fade-up" data-aos-duration="2000"  className="w-[80%] text-center z-3 lg:w-[50%]">Aspiring Tech Artist: Blending logic and creativity, I'm an IT whiz-in-training with a passion for weaving vibrant, user-friendly web experiences. Join me on the journey</span>
        <Link to="https://github.com/VilBRabad/portFolio" target="_blank"><FaGithub className="absolute text-white text-3xl bottom-0 right-4"/></Link>
      </div>
