...
function LastPage() {
  return (
    <div className="h-screen w-screen relative text-white flex justify-center items-center">
      <div className="container flex flex-col h-full w-full justify-center items-center relative ">
         ...
         <span className="text-[4.5rem] font-bold">Thank You for Visiting</span>
      ...
      <div className="colors absolute h-[20rem] w-[20rem] bg-[#F806CC] opacity-[20%] top-[35%] left-[45%] rounded-full blur-3xl z-2" />
